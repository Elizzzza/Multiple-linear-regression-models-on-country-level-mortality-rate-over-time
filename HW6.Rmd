...
```{r Q1_a, echo=F, warning=F, message=F, fig.width=8, fig.height=5, fig.cap="Scatterplot of Log county-level mortality associated with gender and age group in the WONDER dataset"}
### -----------------------------------------------------------
### Q1
